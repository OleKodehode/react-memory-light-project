export default function GamePopup({ start, gameInfo }) {
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-xs z-40">
      <dialog className="fixed w-1/2 top-10 left-50 lg:top-40 lg:left-100 h-auto z-50 p-10 rounded-2xl flex flex-col justify-center items-center gap-8 dark:bg-slate-900 dark:text-zinc-200">
